...
.bg {
	background-image:
		 url("${pageContext.request.contextPath}/assets/img/6hXIMqi.gif"); 
						...
						<div class="row">
							...
							<div class="col-lg-6">
								...
								<div class="card-body">
									...
									<div>
										<span class="text-primary">오늘 하루
										<span class="text-rainbow"><%=application.getAttribute("Counter")%></span>번쨰 방문하셨습니다!</span>
									</div>
								</div>
							</div>
						</div>
